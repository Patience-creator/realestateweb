...
function initStreetView() {
  ...
  const Antwerp = {lat: 37.7575, lng: -122.4377};
...
function initMap() {
  ...
  const Antwerp = {lat: 51.2194, lng: -122.4377};
  // The map, centered at Antwerp
  const map = new google.maps.Map(
      document.getElementById('map'), {zoom: 12, center: Antwerp});
  // The marker, positioned at Antwerp
  const marker = new google.maps.Marker({position: Antwerp, map: map});
}